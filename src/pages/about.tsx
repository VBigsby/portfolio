        ...
        <Layout>
            <header className="aboutHeader">
                <div className="container tc">
                    <h2>Victoria is a UX/UI Designer</h2>
                    <h2>Who loves to make dreams into reality</h2>
                </div>
            </header>
            ...
            <section className="container">
                <div className="grid aboutGrid">
                    ...
                    <div className="infoBlock">
                        <h2>About</h2>
                        <p>
                            Hello, my name is Victoria Bigsby, I am a student enrolled in Springboard UX/UI intensive
                            Bootcamp curriculum, a User Experience Research for the UX community group known as Iterate
                            UX, and I am an Intern as a UX Designer for Smarsh. I am currently based in Portland, Oregon
                            with six months of Design Experience.
                        </p>
                    </div>
                    ...
                    <div className="infoBlock">
                        ...
                        <p>
                            ...
                            Communication Disorder Science. I was immediately employed at a Translation company known as
                            LanguageLine Solutions. There I built my professional skills for Project Management for the
                            last three years. During the COVID pandemic, I took the time to revaluate my current work
                            situation and found out that I wanted to do so much more with my creative side and also
                            wanted to continually learn. That is where I truly found my passion as a Designer and went
                            down the rabbit hole to the world of a UX/UI Designer.
                        </p>
                    </div>
                    ...
                    <div className="infoBlock">
                        ...
                        <p>
                            I started my journey by attending a Bootcamp curriculum from SpringBoard. I have gained so
                            much insight from this program and was a great starting place for someone brand new into
                            this field. I then started to branch off to meetup communities to solidify the concepts that
                            I have learned from my Bootcamp. The one meetup community that I found that helped me grow
                            as a designer was Iterate UX. A community founded in Vancouver, Canada by Leticia Serrano. I
                            began just attending the meetups every week, then I participated in one of their Design
                            Challenges, and then was offered to work part-time as a User Experience Researcher for this
                            community. I am truly thankful for this community for being able to support me as a designer
                            and allowing me to learn more from this community and to support them as well. I believe
                            that this opportunity has allowed me to build my confidence as a designer.
                        </p>
                    </div>
                    ...
                    <div className="infoBlock">
                        ...
                        <p>
                            Multi-tasking my work as a Project Manager, a student from SpringBoard, and doing part-time
                            work for Iterate UX as a User Experience Researcher was tiring, to say the least. But I
                            enjoyed this journey so much and it truly paid off. Although I have not finished my Bootcamp
                            I was given the great opportunity to intern for a company known as Smarsh. Excitedly I start
                            on January 11th as a UX designer. I am so excited about where this journey takes me and so
                            happy to work with a new group of designers. I am excited to learn, struggle, and of course
                            Design!
                        </p>
                    </div>
                </div>
